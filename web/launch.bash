...
. /opt/atlassian/jira/common.bash

#sudo own-volume
rm -f /var/jira_home/.jira-home.lock
...
if [ -n "$DATABASE_URL" ]; then
  extract_database_url "$DATABASE_URL" DB /opt/atlassian/jira/lib
  ...
  cat <<END > /var/jira_home/dbconfig.xml
